  ...
  submitForm: body => {
    return new Promise((resolve, reject) => {
      ...
      fetch(eventintegration.ajaxurl, {
        method: 'POST',
        body
      }).then(res => res.json()).then(json => resolve(json)).then(() => {
...
/* harmony import */ var _form_submit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./form-submit */ "./source/js/front/form-submit.js");
/* harmony import */ var _form_submit__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_form_submit__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _form_validate_date__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./form-validate-date */ "./source/js/front/form-validate-date.js");
/* harmony import */ var _form_validate_date__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_form_validate_date__WEBPACK_IMPORTED_MODULE_5__);
