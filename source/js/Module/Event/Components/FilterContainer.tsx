		...
		<div className="o-grid">
			{settings.mod_event_filter_search && (
				<div className="o-grid-12 o-grid">
					<SearchBar translation={translation} searchString={searchString} updateSearchString={updateSearchString} />
				</div>
			)}
			...
			{settings.mod_event_filter_age_group && (
				<div className="o-grid-12@xs o-grid-4@md o-grid-4@lg o-grid-4@xl">
					<AgeFilter translation={translation} onChange={onAgeRangeChange} />
				</div>
			)}
			...
			<div className="o-grid o-grid-12@md u-margin__top--1 u-margin__top--3@md u-margin__top--3@lg u-margin__top--3@xl">
				...
				{settings.mod_event_filter_tags && tags.length > 0 && (
					<div className="o-grid-fit">
						<CategoriesFilter title={translation.tags} categories={tags} onCategoryChange={onTagChange} />
					</div>
				)}
				...
				<div className="o-grid-fit">
					...
					>
						<span className="c-button__label">
							<span className="c-button__label-text">{translation.search}</span>
						</span>
					</button>
				</div>
				...
				{resetButton && (
					<div className="o-grid-fit">
						...
						>
							<span className="c-button__label">
								<span className="c-button__label-text">{translation.resetFilters}</span>
							</span>
						</a>
					</div>
				)}
