    ...
    public static function geFields($id = 0)
    {
        ...
        $fields = array(
            ...
            'content' => (object) array(
                ...
                'description' => !empty($data['content']['description']) ? $data['content']['description'] : __('Describe your event. What happens and why should you visit it?', 'event-integration') . '<br>' . __('Plain language tips', 'event-integration') . ':<br>' . __('Write the most important first.', 'event-integration') . '<br>' . __('Use words that you think the readers understand.', 'event-integration') . '<br>' . __('Write short and concise.', 'event-integration'),
                'required' => true,
                'hidden' => false,
            ...
            'image_input' => (object) array(
                ...
                'description' => !empty($data['image_input']['description']) ? $data['image_input']['description'] : __('Keep in mind that the image may be cropped, so avoid text in the image.', 'event-integration') . '<br>' . __('Images with identifiable persons are not accepted and will be replaced.', 'event-integration') . '<br>' . __('You must also have the right to use and distribute the image.', 'event-integration'),
        ...
        $fields['translations'] = [
            ...
            'identifiablePersons' => __('Are there identifiable persons on the image?', 'event-integration'),
